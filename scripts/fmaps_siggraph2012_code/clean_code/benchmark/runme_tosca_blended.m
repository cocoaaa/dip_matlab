...
numSegMatches = 3;
[segMatches1,resid1,~,candidates] = findSegmentMatches(mesh1, basis1, mesh2, basis2, numSegMatches);
% Start from second candidate
segMatches = candidates(2,:);
[segMatches2,resid2] = findSegmentMatches(mesh1, basis1, mesh2, basis2, numSegMatches, segMatches);
if resid1 < resid2
