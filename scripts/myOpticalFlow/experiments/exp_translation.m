...
im2 = zeros(30,50);
im2(11:21, 11:31) = 1;% vanilla OF works.

% exp3: bigger translation (+2, +2 in both directions)
% im2 = zeros(30,50);
% im2(12:22, 12:32) = 1; %vanilla OF breaks.
...
%         if (iter == 2 || toSimulate)
    ...
    figure; imshow(estimated_color); title(sprintf("flow estimation lambda: %.3f", lambda));
